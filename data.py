...
recipes = [
    ...
    ("Chinese Eggplant Stir Fry", "chinese", ["eggplant", "soy sauce", "garlic", "chili"]),
    ...
    ("Dan Dan Noodles", "chinese", ["noodles", "ground pork", "chili oil", "scallions"]),
...
# - Indian: "chicken", "onion", "spices" (for Chicken Curry)
# - Indian: "cabbage", "mustard seeds", "spices" (for Cabbage Sabzi)
# - Chinese: "chicken", "peanuts", "chili", "scallions" (for Kung Pao Chicken)
# - Chinese: "noodles", "chicken", "cabbage", "carrot" (for Chicken Chow Mein)
# - Chinese: "cabbage", "soy sauce", "garlic" (for Cabbage Stir Fry)
